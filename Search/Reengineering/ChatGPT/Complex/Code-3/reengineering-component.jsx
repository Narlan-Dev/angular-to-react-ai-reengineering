    ...
    <div className={styles.card}>
      <form className={styles.formHorizontal} onSubmit={handleSubmit}>
        <div className={`${styles.cardBody} ${styles.paddingNull}`}>
          ...
          <div className={`${styles.formGroup} ${styles.row} ${styles.dFlex} ${styles.alignItemsCenter} ${styles.justifyContentBetween} ${styles.formGap}`}>
            <div
              className={`${styles.colSm8} ${styles.formContainer} ${
            ...
            >
              <input
                ...
                required
                placeholder={
                  submitted && errors.title ? 'Necessário informar o título' : ''
                }
            ...
            {(formValues.type === '0_to_100' || formValues.type === '0_to_5') && (
              <div className={`${styles.colSm2} ${styles.formContainer}`}>
                <input
                  ...
                  required
                  placeholder={isWeightInvalid() ? 'Necessário informar o peso' : ''}
                  min={0}
                  max={100}
            ...
            <div className={styles.colSm2}>
              <select
                className={`select2 form-control font-big ${styles.formQuestionContainer}`}
          ...
          <div className={`${styles.formGroup} ${styles.row} ${styles.dFlex} ${styles.alignItemsCenter} ${styles.justifyContentBetween}`}>
